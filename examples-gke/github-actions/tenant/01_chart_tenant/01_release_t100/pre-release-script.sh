...
###############################################################################
export tenant_pg_db_server=$( get_secret tenant_pg_db_server )
...
###############################################################################
export tenant_pg_admin=$( get_secret tenant_pg_admin )
export tenant_pg_admin_pass=$( get_secret tenant_pg_admin_pass )
###############################################################################
...
###############################################################################
create_secret dbserver          dbserver      $tenant_pg_db_server
